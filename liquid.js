...
const images = [
  ...
  backgroundDisplacementSprite: 'map-9.jpg', // slide displacement image 
  ...
  cursorScaleIntensity : 0.75, // cursor effect intensity
  ...
  textTitleSize : 50, // title size
  mobileTextTitleSize : 125, // title size
  textTitleLetterspacing : 3, // title letterspacing
  
  textSubTitleColor : 'white', // subtitle color ex : 0x000000
  textSubTitleSize : 21, // subtitle size
  mobileTextSubTitleSize : 11, // mobile subtitle size
